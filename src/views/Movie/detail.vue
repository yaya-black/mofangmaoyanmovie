...
<div id="detailContainer" class="slide-enter-active">
   <Header title='影片详情'>
       <i class="iconfont icon-right" @click="handeleToback"></i>
   </Header>
			...
			<div class="detail_list">
				...
				<div class="detail_list_content">
					...
					<div class="detail_list_info">
						...
						<p>{{detailMovie.sc}}</p>
						<p>{{detailMovie.cat}}</p>
						<p>{{detailMovie.frt}} /{{detailMovie.dur}}</p>
...
<style scoped>
#detailContainer{position:absolute;left:0px;top:0px;z-index: 500;width:100%;background:white;min-height: 100%;}
